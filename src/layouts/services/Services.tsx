...
const Services: React.FC = () => {
    ...
    return (
        <section className="max-w-screen-2xl px-4 h-full mx-auto" style={{ margin: '3.5rem 0' }}>
            ...
            <div className="service-wrap">
                <ul className={styles["service-list"]}>
                    <li className={styles["service-item"]}>
                        ...
                        <img src="https://i.imgur.com/IbGLLHV.jpg" alt="" className={styles["service-img"]} />
                    ...
                    <li className={styles["service-item"]}>
                        ...
                        <img src="https://i.imgur.com/bbayDRB.jpg" alt="" className={styles["service-img"]} />
                        <div className={styles["service-actions"]}>
                            <button className={styles["service-btn"]}>
                                <Link href="#">
                                    <PlusIcon className="text-white w-6" />
                    ...
                    <li className={styles["service-item"]}>
                        ...
                        <img src="https://i.imgur.com/yg63l3E.jpg" alt="" className={styles["service-img"]} />
                        <div className={styles["service-actions"]}>
                            <button className={styles["service-btn"]}>
                                <Link href="#">
                                    <PlusIcon className="text-white w-6" />
                        ...
                        {testimonialsData.map((testimonial, index) => (
                            <SwiperSlide key={index}>
                                <div className={`${styles["testimonial-item"]} testimonial-item`}>
                                    ...
                                    <img src={testimonial.image} className={styles["testimonial-img"]} alt="" />
