...
const FaqItem: React.FC<FaqItemProps> = ({ question, answer, index, isOpen, handleToggle }) => {
  return (
    <li>
      <div className="py-3 px-4 text-center bg-white rounded-xl flex justify-between items-center mb-2" onClick={() => handleToggle(index)}>
        <p>{question}</p>
